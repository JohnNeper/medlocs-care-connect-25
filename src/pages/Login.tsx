...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-hero flex">
        ...
        <CardContent>
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              <MedicalButton variant="outline" type="button" className="w-full">
      ...
      <div className="hidden lg:flex flex-1 items-center justify-center bg-gradient-to-br from-primary/20 to-primary/5 p-8">
